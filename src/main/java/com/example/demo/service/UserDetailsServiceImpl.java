...
{
    private static final String ROLE_NAME = "SIMPLE_ROLE";
    protected static final Set<GrantedAuthority> GRANTED_AUTHORITIES = Set.of(new SimpleGrantedAuthority(ROLE_NAME));
